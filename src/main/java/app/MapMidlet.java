...
//      String s1="$GPGSV";
//      String s="$GPGSV,2,4,23";
//      int i = s.scompareTo(s1);
//
//      i+=0;
...
//      public void run(){
//        if (true) return;
//        MapUtil.version=getAppProperty("MIDlet-Version");
//        
//        splashCanvas = new SplashCanvas();
//        MapCanvas.setCurrent(splashCanvas);
//        try{
//          ulp(10);
//          
////          while(!splashIsShown){
...
//              }catch(Throwable e){
////#debug
//                DebugLog.add2Log("FR M:" + e.toString());
//              }
//            
//          }catch(Throwable tt){}
...
//          try{MapSound.playTone(MapSound.APPSTARTTONE);}catch(Throwable t) {}
//          //Thread.sleep(500);
//          //if (RMSOption.langSelected) {
//          //  splashCanvas.percent=95;
//          ulp(98);
//          try{
//            if (RMSOption.netRadarWasActive) MapCanvas.map.startNetRadar(false);
//          }catch(Throwable t) {
//            //#debug
//            DebugLog.add2Log("NR mmst:" + t.toString());
//          }
//          ulp(99);
//          try{
...
//          }catch(Throwable t) {
//            //#debug
//            DebugLog.add2Log("GP sald:" + t.toString());
//          }
//          
//          // } else {
...
//#                 DebugLog.add2Log("FR M:" + e);
          ...
          ulp(95);
          // splashCanvas.percent=90;
          try{MapSound.playMIDISound(MapSound.APPSTARTTONE);}catch(Throwable t) {}
          //Thread.sleep(40);
          //Thread.sleep(500);
          //if (RMSOption.langSelected) {
          //  splashCanvas.percent=95;
...
//#             DebugLog.add2Log("GP sald:" + t);
          ...
          if (MapCanvas.autoShowMap){
            if (waitForAds) Thread.sleep(3000);
          MapCanvas.setCurrentMap();
          MapCanvas.map.repaint();
          }
        }catch(Throwable t){
...
//#endif
      ...
      protected void keyPressed(int keyCode) { if (ready2close) MapCanvas.setCurrent(MapCanvas.map); }
      protected void pointerPressed(int x, int y) {if (ready2close) MapCanvas.setCurrent(MapCanvas.map); }
      int rx,ry;
...
//                  (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(ca)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(ca)+1.5),
//                  (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(cb)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(cb)+1.5));
//              g.drawString(MapUtil.SH_NORTH, (int)(dcx+(sr+ps)*Math.cos(crsr)+1.5), (int)(dcy+(sr+ps)*Math.sin(crsr)-fh/2+1.5), Graphics.TOP|Graphics.HCENTER );
//
//              crsr = crsr+MapUtil.PIdiv4;
//              ca=crsr+MapUtil.PIdiv2;
//              cb=crsr-MapUtil.PIdiv2;
...
////              (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(ca)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(ca)+1.5),
////              (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(cb)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(cb)+1.5));
//              g.drawString(MapUtil.SH_NORTHEAST, (int)(dcx+(sr+ps)*Math.cos(crsr)+1.5), (int)(dcy+(sr+ps)*Math.sin(crsr)-fh/2+1.5), Graphics.TOP|Graphics.HCENTER );
//
//              crsr = crsr+MapUtil.PIdiv4;
//              ca=crsr+MapUtil.PIdiv2;
//              cb=crsr-MapUtil.PIdiv2;
...
//                  (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(ca)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(ca)+1.5),
//                  (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(cb)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(cb)+1.5));
//              g.drawString(MapUtil.SH_EAST, (int)(dcx+(sr+ps)*Math.cos(crsr)+1.5), (int)(dcy+(sr+ps)*Math.sin(crsr)-fh/2+1.5), Graphics.TOP|Graphics.HCENTER );
//
//              crsr = crsr+MapUtil.PIdiv4;
//              ca=crsr+MapUtil.PIdiv2;
//              cb=crsr-MapUtil.PIdiv2;
...
////              (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(ca)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(ca)+1.5),
////              (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(cb)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(cb)+1.5));
//              g.drawString(MapUtil.SH_SOUTHEAST, (int)(dcx+(sr+ps)*Math.cos(crsr)+1.5), (int)(dcy+(sr+ps)*Math.sin(crsr)-fh/2+1.5), Graphics.TOP|Graphics.HCENTER );
//
//              crsr = crsr+MapUtil.PIdiv4;
//              ca=crsr+MapUtil.PIdiv2;
//              cb=crsr-MapUtil.PIdiv2;
...
//                  (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(ca)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(ca)+1.5),
//                  (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(cb)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(cb)+1.5));
//              g.drawString(MapUtil.SH_SOUTH, (int)(dcx+(sr+ps)*Math.cos(crsr)+1.5), (int)(dcy+(sr+ps)*Math.sin(crsr)-fh/2+1.5), Graphics.TOP|Graphics.HCENTER );
//
//              crsr = crsr+MapUtil.PIdiv4;
//              ca=crsr+MapUtil.PIdiv2;
//              cb=crsr-MapUtil.PIdiv2;
...
////              (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(ca)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(ca)+1.5),
////              (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(cb)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(cb)+1.5));
//              g.drawString(MapUtil.SH_SOUTHWEST, (int)(dcx+(sr+ps)*Math.cos(crsr)+1.5), (int)(dcy+(sr+ps)*Math.sin(crsr)-fh/2+1.5), Graphics.TOP|Graphics.HCENTER );
//
//              crsr = crsr+MapUtil.PIdiv4;
//              ca=crsr+MapUtil.PIdiv2;
//              cb=crsr-MapUtil.PIdiv2;
...
//                  (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(ca)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(ca)+1.5),
//                  (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(cb)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(cb)+1.5));
//              g.drawString("W", (int)(dcx+(sr+ps)*Math.cos(crsr)+1.5), (int)(dcy+(sr+ps)*Math.sin(crsr)-fh/2+1.5), Graphics.TOP|Graphics.HCENTER );
//
//              crsr = crsr+MapUtil.PIdiv4;
//              ca=crsr+MapUtil.PIdiv2;
//              cb=crsr-MapUtil.PIdiv2;
...
//              //     (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(ca)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(ca)+1.5),
//              //     (int)(dcx+sr*Math.cos(crsr)+5*Math.cos(cb)+1.5), (int)(dcy+sr*Math.sin(crsr)+5*Math.sin(cb)+1.5));
//              g.drawString("NW", (int)(dcx+(sr+ps)*Math.cos(crsr)+1.5), (int)(dcy+(sr+ps)*Math.sin(crsr)-fh/2+1.5), Graphics.TOP|Graphics.HCENTER );
//
            ...
            if ((logo!=null)&&(!waitForAds)) g.drawImage(logo,rx,ry,Graphics.HCENTER|Graphics.VCENTER);
...
//          g.drawString("Navigator", dcx, dcy, Graphics.TOP| Graphics.HCENTER);
//          g.setColor(MapUtil.fadeColor(0xFFFFFF, percent) );
//          //g.setColor(0xFFFFFF);
//          g.setFont(Font.getDefaultFont());
//          int fhd=g.getFont().getHeight();
//          g.drawString("Your Java2ME + GPS", dcx, dmaxy-fhd-fhd-fhd, Graphics.TOP| Graphics.HCENTER);
//          g.drawString("Navigation System", dcx, dmaxy-fhd-fhd, Graphics.TOP| Graphics.HCENTER);
